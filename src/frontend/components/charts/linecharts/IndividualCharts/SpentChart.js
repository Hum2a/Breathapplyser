    ...
    return (
        <View style={chartStyles.chartContainer}>
            ...
            <Picker
                ...
                style={chartStyles.pickerStyle} // You can define this style in your chartStyles
            >
                ...
                <View>
                    <LineChart
                        data={{
                            labels: chartLabels,
                            datasets: [
                                { data: amountSpentValues, color: () => chartConfig.chartColors[0] },
                                // Include the second dataset if in comparison mode
                                ...(comparisonMode && amountSpentValues2.length > 0
                                    ? [{ data: amountSpentValues2, color: () => chartConfig.chartColors[1] }]
                                    : [])
                            ],
                        }}
                        width={350}
                    ...
                    <View style={chartStyles.legendContainer}>
                        ...
                        <Text style={chartStyles.legendLabel}>Amount Spent</Text>
                    </View>
                </View>
            ) : (
                <Text style={chartStyles.noDataText}>No data available for this date.</Text> // Style this as needed
            )}
        </View>
    );
}
